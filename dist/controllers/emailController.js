...
const personas = __importStar(require("../models/email"));
    ...
    sendEmail(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                console.log(cohorte);
                yield personas.sendEmail((_a = cohorte === null || cohorte === void 0 ? void 0 : cohorte.toString()) !== null && _a !== void 0 ? _a : '');
                res.status(200).json({
    ...
    verifyEmail(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const result = yield personas.verifyEmail(token);
                res.status(200).json({
                    data: result,
